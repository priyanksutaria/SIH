...
const PerceptualQuestion = ({ question, options, selectedAnswer, onAnswerChange }) => {
  ...
  return (
    <div className="question">
      <p>{question.text}</p>
      <img src={question.image} width="600px" alt={`Question ${question.id}`} className="question-image" />
